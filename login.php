        ...
        <div class="container">
            <div class="row no-gutters">
                ...
                <div class="col-lg-7 px-5 pt-5">
                    ...
                    <form id="contact-form" name="contact-form" action="loginprocess.php" method="POST" >
                        <div class="form-row">
                            <div class="col-lg-7">
                        ...
                        <div class="form-row">
                            <div class="col-lg-7">
                              <input type="password" name="upass" placeholder="Password" class="form-control my-3 p-4">
                            </div>
                        </div>
