...
<body class="sub_page">
      ...
      <div class="row">
        <div class="col-md-6 ">
          <div class="heading_container ">
            ...
            <h6><i>Once an user is deleted, it cannot be restored. </i> </h6>
          </div>
          <form action="deleteuserprocess.php" method="POST">
      <!-- <input type="button"  value="Profile" onclick="profilefn();"> -->
     

      <input class="form-control" type="text" id="uname" name="uname" placeholder="Enter the username of user" required >
  ...
  <script>
    function redirectfn(){
        location.assign('deleteuserprocess.php'); ///GET method
    }
    function logoutfn(){
