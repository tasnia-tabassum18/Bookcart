...
<body class="sub_page">
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="signnup.php">Shop</a>
              </li>
              <li class="nav-item">
  ...
  <section class="about_section layout_padding">
    <div class="container ">
      <div class="row">
        <div class="col-md-6">
            <img src="images/r1.png" width="200" height="200">
            
           
          </div>
          <div class="col-md-6">
            <img src="images/r2.png" width="200" height="200">
          ...
          <div class="col-md-6">
            ...
            <img src="images/r3.png"width="200" height="200">
          </div>
          <div class="col-md-6">
            <img src="images/r4.png" width="200" height="200">
